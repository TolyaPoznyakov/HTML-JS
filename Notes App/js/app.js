...
function createNote(title, text)    {
    ...
    <div class="note-header">
        ...
        <textarea id="note-title-input" class="hidden" placeholder="${title}"></textarea>
        <div>
    ...
    <textarea id="note-textarea" class="hidden" placeholder="${text}"></textarea>
    `
...
addBtn.addEventListener('click', (e) => {
    const el = createNote("Heading", "Your text");
